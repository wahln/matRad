classdef (Abstract) matRad_OmegaConstraint
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    methods %(Abstract)
        ...
        function cDose        = computeTotalVarianceConstraintFunction(obj,dose)
        ...
        function cDoseJacob   = computeTotalVarianceConstraintJacobian(obj,dose)
          error('Function needs to be implemented!');
        end
