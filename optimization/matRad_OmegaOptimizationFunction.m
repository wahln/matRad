classdef (Abstract) matRad_OmegaOptimizationFunction
% matRad_DoseOptimizationFunction. Superclass for objectives and
% constraints for total variance
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    properties
        robustness = 'PROB';    %Robustness setting -> may be removed from the DoseObjective class in a future release
    end
    
    methods
        function obj = matRad_OmegaOptimizationFunction(dataStruct)
